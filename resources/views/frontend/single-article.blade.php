                  ...
                  <div class="page">
                    ...
                    <div class="page-body">
                      ...
                      <div class="single-article">
                        <img
                          src="{{ asset('storage/upload/' .$content->article_cover_image)}}"
                          class="img-fluid"
                          alt=""
                        />
                        <div class="single-article-detail">
                          <div class="auth-detail">
                            <img src="{{ asset('storage/upload/' .$content->writer_image)}}" alt="" />
                            <div>
                              {{$content->writer_name}}
                              <br />
                      ...
                      <div class="fb-comments" data-href="https://adarshaschool.edu.np/website/public/index.php/article/fifth" data-width="" data-numposts="10"></div>
                      <!-- end -->
                    </div>
                  </div>
                </div>
