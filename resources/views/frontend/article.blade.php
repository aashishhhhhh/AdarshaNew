                                ...
                                <div class="page-body">
                                    ...
                                    <div class="article_item first">
                                        ...
                                        <div class="article_item_header">
                                            <a class="title"
                                                href="{{ route('single-article', $latestArticle->slug) }}">
                                                <h1>{{ $latestArticle->title }}</h1>
                                            </a>
                                            <div class="article_detail">
                                                <div class="auth-detail">
                                                    <img src="assets/images/logo.jpg" class="auth-img" alt="" />
                                                    ...
                                                    <div class="article_item2">
                                                        ...
                                                        <div class="article_item2-des">
                                                            <h2 class="articl_item_title2">
                                                                <a href="{{ route('single-article', $value->slug) }}">{{ $content->article_title }}
                                                                </a>
                                                            </h2>
                                                            <div class="article_detail2">
                                                                <div class="auth-detail2">
                                                                    <img src="{{ asset('storage/upload/' . $content->writer_image) }}"
                                                                        class="auth-img2" alt="" />
                                                                    <span class="auth-name2">
                                                                        {{ $content->writer_name }}</span>
                                                                </div>
                                                                <div class="art-date2">
