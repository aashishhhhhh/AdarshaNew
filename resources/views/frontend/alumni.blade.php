              ...
              <div class="left-box">
                ...
                <div class="page">
                  ...
                  <div class="page-body">
                    ...
                    <form action="{{route('alumni-form-store')}}" method="POST" class="mt-4 card p-4" enctype="multipart/form-data">
                        @csrf
                      <div class="row">
                        <div class="col-md-12">
                          <label
                            class="form-label"
                            >Full Name <span class="danger"> *</span></label
                          >
                          <input
                            type="text"
                            class="form-control"
                        ...
                        <div class="col-md-12">
                            <label
                              class="form-label"
                              >Image <span class="danger"> </span></label
                            >
                            <input
                              type="file"
                              class="form-control"
                       ...
                       @enderror
                        ...
                        <div class="col-md-6 mt-3">
                          <label
                            class="form-label"
                            >Current Job <span class="danger"> *</span></label
                          >
                          <input
                            type="text"
                            class="form-control"
                       ...
                       @enderror
                        ...
                        <div class="col-md-6 mt-3">
                          <label
                            class="form-label"
                            >Designation <span class="danger"> *</span></label
                          >
                          <input
                            type="text"
                            class="form-control"
                       ...
                       @enderror
                        ...
                        <div class="col-md-6 mt-3">
                          <label
                            class="form-label"
                            >Contact No. <span class="danger"> *</span></label
                          >
                          <input
                            type="text"
                            class="form-control"
                       ...
                       @enderror
                        ...
                        <div class="col-md-6 mt-3">
                            <label
                              class="form-label"
                              >School Admission Year <span class="danger"> *</span></label
                            >
                            <input
                              type="text"
                              class="form-control"
                         ...
                         @enderror
                          ...
                          <div class="col-md-6 mt-3">
                            <label
                              class="form-label"
                              >School Leave Year <span class="danger"> *</span></label
                            >
                            <input
                              type="text"
                              class="form-control"
                         ...
                         @enderror
                          ...
                          <div class="col-md-6 mt-3">
                            <label
                              class="form-label"
                              >Starting Class in This School <span class="danger"> *</span></label
                            >
                            <input
                              type="text"
                              class="form-control"
                         ...
                         @enderror
                          ...
                          <div class="col-md-6 mt-3">
                            <label
                              class="form-label"
                              >Leaving Class in This School <span class="danger"> *</span></label
                            >
                            <input
                              type="text"
                              class="form-control"
              ...
              <div class="right-box">
                ...
                <div class="photo-gallery">
                  ...
                  <div class="owl-carousel gallery owl-theme">
                    ...
                    <div class="item">
                      <a class="gimg" href="assets/images/banner002.jpg"
                        ><img
